...
def main(cfg: DictConfig):
    ...
    trainloaders, validationloaders, testloader = prepare_dataset(
        cfg.datasets, cfg.sim_num_clients, cfg.batch_size, is_uniform=cfg.uniform_data_distribution
    )
    ...
    client_fn = generate_client_fn(trainloaders, validationloaders)
    ...
    strategy = fl.server.strategy.FedAvg(
        ...
        min_fit_clients=cfg.sim_num_clients_per_round_fit,  # number of clients to sample for fit()
        fraction_evaluate=0.0,  # similar to fraction_fit, we don't need to use this argument.
        min_evaluate_clients=cfg.sim_num_clients_per_round_eval,  # number of clients to sample for evaluate()
        min_available_clients=cfg.sim_num_clients,  # total clients in the simulation
    ...
    history = fl.simulation.start_simulation(
        ...
        num_clients=cfg.sim_num_clients,  # total number of clients
